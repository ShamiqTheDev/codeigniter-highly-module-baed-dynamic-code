...
class LossesPaidFire extends CI_Controller {
    ...
    /**
     *
     *  LossesPaidFire Listing Service 
     *
    */
    public function index()
    {
        ...
        $dataColumns = [
            ...
            'grossEstimatedLoss' => $this->lang->line('col_grossEstimatedLoss'), 
        ...
        $ListingConfig = [
            'PageTitle'     =>$this->lang->line('menu_lossespaidfire'),
            'URl'           => current_url(),
