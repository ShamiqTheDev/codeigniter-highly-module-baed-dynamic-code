...
class PremiumMarineCargo extends CI_Controller {
    ...
    /**
     *
     *  PremiumMarineCargo Listing Service 
     *
    */
    public function index()
    {
        ...
        $dataColumns = [
            ...
            'vessel' => $this->lang->line('col_typeofPolicy'),
            'sellingDate' => 'Sailing Date',
            'voyageFrom' => $this->lang->line('col_from'), 
            'voyageTo' => $this->lang->line('col_To'), 
            'grossInsured' => $this->lang->line('col_grossInsured'),
            'grossPremium' => $this->lang->line('col_grossPremium'),
            'treatyInsured' => $this->lang->line('col_TreatyInsured'),
            'treatyPremium' => $this->lang->line('col_TreatyPremium'), 
        ...
        $ListingConfig = [
            'PageTitle'     => $this->lang->line('menu_premiummarinecargo'),
            'URl'           => current_url(),
    ...
    */
    ...
    {
        $data = [
            'pageTitle' => 'Premium Marine Cargo',
            'form' => [
    ...
    /**
     *
     *  PremiumMarineCargo Create Service 
     *
    */
    ...
    /**
     *
     *  PremiumMarineCargo Edit Service 
     *
    */
    ...
    /**
     *
     *  PremiumMarineCargo View Service 
     *
    */
    ...
    /**
     *
     *  PremiumMarineCargo Delete Service 
     *
    */
