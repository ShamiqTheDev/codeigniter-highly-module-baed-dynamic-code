...
class PremiumFire extends CI_Controller {
    ...
    /**
     *
     *  PremiumFire Listing Service 
     *
    */
    public function index()
    {
        if ($this->input->post('get_data')) {
            $post = $this->input->post();$post = array_merge($post,$this->config->item('listing'));
            unset($post['get_data']);
        ...
        $dataColumns = [
            ...
            'cessionNo' => $this->lang->line('col_cessionNo'),
            'insured' => $this->lang->line('menu_insured'),
            'particularOfRisk' => $this->lang->line('col_particularOfRisk'),
            'periodFrom' => $this->lang->line('col_from'), 
            'periodTo' => $this->lang->line('col_To'), 
            'grossAmountInsured' => $this->lang->line('col_grossInsured'),
            'grossAmountPremium' => $this->lang->line('col_grossPremium'),
            'surplusTreatyInsured' => $this->lang->line('col_TreatyInsured'),
            'surplusTreatyPremium' => $this->lang->line('col_TreatyPremium'),
            'prclShareInsured' => $this->lang->line('col_prclShareInsured'),
            'prclSharePremium' => $this->lang->line('col_prclSharePremium'),
        ];
        ...
        $ListingConfig = [
            'PageTitle'     => $this->lang->line('menu_premiumfire'),
            'URl'           => current_url(),
