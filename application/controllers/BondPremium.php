...
class BondPremium extends CI_Controller {
    ...
    */
    public function index()
    {
        ...
        $ListingConfig = [
            'PageTitle'     =>$this->lang->line('menu_bondpremium'),
            'URl'           => current_url(),
