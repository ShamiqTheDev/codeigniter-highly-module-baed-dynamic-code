...
class LossesPaidBond extends CI_Controller {
    ...
    /**
     *
     *  LossesPaidBond Listing Service 
     *
    */
    public function index()
    {
        ...
        $dataColumns = [
            ...
            'typeOfLoss' => $this->lang->line('col_particularsofLoss'), 
        ...
        $ListingConfig = [
            'PageTitle'     => $this->lang->line('menu_losespaidbond'),
            'URl'           => current_url(),
