...
<div class="br-mainpanel">
    <div class="pd-30">
        ...
        <p class="mg-b-0">Welcome to Pakistan Reinsurance Company Limited</p>
    </div><!-- d-flex -->
    <div class="row">
        ...
        <div class="row row-sm">
                ...
                <div class="bg-teal rounded overflow-hidden">
                    <div class="pd-25 d-flex align-items-center">
                        ...
                        <div class="mg-l-20">
                            ...
                            <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">2500</p>
                            <span class="tx-11 tx-roboto tx-white-6">4% From last Week</span>
                        </div>
                    </div>
                </div>
            </div><!-- col-3 -->
            <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
                <div class="bg-danger rounded overflow-hidden">
                    <div class="pd-25 d-flex align-items-center">
                        ...
                        <div class="mg-l-20">
                            <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Average Time</p>
                            <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">123.50</p>
                            <span class="tx-11 tx-roboto tx-white-6">3% From last Week</span>
                        </div>
                    </div>
                </div>
            </div><!-- col-3 -->
            <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
                <div class="bg-primary rounded overflow-hidden">
                    <div class="pd-25 d-flex align-items-center">
                        ...
                        <div class="mg-l-20">
                            <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10"> Total Collections</p>
                            <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">2,315</p>
                            <span class="tx-11 tx-roboto tx-white-6">34% From last Week</span>
                        </div>
                    </div>
                </div>
            </div><!-- col-3 -->
            <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
                <div class="bg-br-primary rounded overflow-hidden">
                    <div class="pd-25 d-flex align-items-center">
                        <i class="ion ion-link tx-60 lh-0 tx-white op-7"></i>
                        <div class="mg-l-20">
                            <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Total Connections
                            </p>
                            <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">7,325</p>
                            <span class="tx-11 tx-roboto tx-white-6">36% From last Week</span>
                        </div>
                    </div>
                </div>
            </div><!-- col-3 -->
