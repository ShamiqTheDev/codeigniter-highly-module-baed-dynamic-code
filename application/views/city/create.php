     ...
     <div class="row">
         <div class="col-sm-12">
             <div class="pd-30 form-heading-container" style="">
                 <h4 class="tx-gray-800 mg-b-5 form-heading">City</h4>
                 <p class="mg-b-0"></p>
             </div>
         </div>
     </div><br>
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" required value="<?php if(isset($data)){print($data->name);}?>" placeholder="City Name" <?php echo $disabled?>>
                                </div>
                            </div>
                        </div>
