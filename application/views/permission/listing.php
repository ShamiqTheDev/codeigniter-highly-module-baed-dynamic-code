    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                ...
                <h4 class="tx-danger  tx-semibold mg-b-20">Are you sure? You want to delete Permission?</h4>
                <?php
                $attributes = array('class' => 'form-horizontal', 'role' => 'delete_permission_popup', 'id' => 'delete_permission_popup');
                echo form_open(base_url()."permission/delete", $attributes);
                ?>
                <input type="hidden" id="id" name="id" value="">
                <?php echo form_close(); ?>

                <button type="button" class="btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20 delete_permission">
                    Continue
                </button>
...
<div class="br-mainpanel">
    ...
    <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Permission Information</h4>
    ...
    <div class="br-pagebody mg-t-5 pd-x-30">
        ...
        <script src="<?php echo $includes_dir; ?>lib/admin/permission/listing.js"></script>
