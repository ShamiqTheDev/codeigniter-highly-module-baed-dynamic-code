    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="pd-30 form-heading-container" style="">
                <h4 class="tx-gray-800 mg-b-5 form-heading">Department</h4>
                <p class="mg-b-0"></p>
            </div>
        </div>
    </div><br>
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    <label class="form-control-label">Deparment Code <span style="color: red">*</span></label>
                                    <input class="form-control" type="text" name="code" value="<?php echo ($action == "edit_record" OR $action == "view_record") ? $data->code  : ""; ?>" placeholder="Enter Department Code" <?php echo $disabled?>>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="name" value="<?php echo ($action == "edit_record" OR $action == "view_record") ? $data->name  : ""; ?>" placeholder="Enter Department Name" <?php echo $disabled?>>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="shortName" value="<?php echo ($action == "edit_record" OR $action == "view_record") ? $data->shortName  : ""; ?>" placeholder="Enter Department Short Name" <?php echo $disabled?>>
                                </div>
                            </div>
