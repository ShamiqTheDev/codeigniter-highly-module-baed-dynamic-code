     ...
     <div class="row">
         <div class="col-sm-12">
             <div class="pd-30 form-heading-container" style="">
                 <h4 class="tx-gray-800 mg-b-5 form-heading">Currency</h4>
                 <p class="mg-b-0"></p>
             </div>
         </div>
     </div><br>
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="code" id="code" placeholder="Enter Currency Code"  value="<?php echo ($action == "edit_record" OR $action == "view_record") ? $data->code  : ""; ?>"  <?php echo $disabled?>>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    <label class="form-control-label">Currency Country <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="country" id="country"  placeholder="Enter Country" value="<?php echo ($action == "edit_record" OR $action == "view_record") ? $data->country  : ""; ?>"  <?php echo $disabled?>>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    <label class="form-control-label">Currency Name <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="name" id="name"  placeholder="Enter Currency Name" value="<?php echo ($action == "edit_record" OR $action == "view_record") ? $data->name  : ""; ?>"  <?php echo $disabled?>>
                                </div>
                            </div>
