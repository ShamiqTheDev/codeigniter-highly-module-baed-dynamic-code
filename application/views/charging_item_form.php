...
<div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Charging Item</span>
        </nav>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="pd-30 form-heading-container" style="">
                <h4 class="tx-gray-800 mg-b-5 form-heading">Charging Item</h4>
                <p class="mg-b-0"></p>
            </div>
        </div>
    </div><br>
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter Name" <?php echo $disabled?> value="<?php echo ($action == "edit_record" OR $action == "view_record") ? $data->name  : ""; ?>"> 
