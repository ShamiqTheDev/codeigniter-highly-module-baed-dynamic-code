...
<div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Condition</span>
        </nav>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="pd-30 form-heading-container" style="">
                <h4 class="tx-gray-800 mg-b-5 form-heading">Condition</h4>
                <p class="mg-b-0"></p>
            </div>
        </div>
    </div><br>
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    <label class="form-control-label">Condition Types <span class="tx-danger">*</span></label>
                                    <select class="form-control select2" data-placeholder="Select Condition Types" id="conditionType" name="conditionType" required <?php echo $disabled?>>
                                        <option value="">Condition types</option>
                                        ...
                                        foreach($conditionTypes as $key => $conditionType)
                                        {
                                            ...
                                            if(isset($data))
                                            {
                                                if($data->conditionTypeDTO->id == $conditionType->id) {
                                                    $selected = 'selected';
                                                }
                                            }
                                            print('<option value="'.$conditionType->id."|".$conditionType->conditionType.'" '.$selected.'>'.$conditionType->conditionType.'</option>');
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="condition" value="<?php echo ($action == "edit_record" OR $action == "view_record") ? $data->condition  : ""; ?>" placeholder="" <?php echo $disabled?>>
                                    <?php if (isset($response->id)) { ?>
                                        <input type="hidden" name="id" value="<?php echo ($action == "edit_record") ? $data->id  : ""; ?>">
                                    <?php } ?>
                                </div>
                            </div>
