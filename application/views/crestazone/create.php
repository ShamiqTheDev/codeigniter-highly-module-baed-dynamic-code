 ...
 <div class="br-mainpanel">
     <div class="br-pageheader pd-y-15 pd-l-20">
         <nav class="breadcrumb pd-0 mg-0 tx-12">
             ...
             <span class="breadcrumb-item active">Cresta Zone</span>
         </nav>
     </div>
     ...
     <div class="row">
         <div class="col-sm-12">
             <div class="pd-30 form-heading-container" style="">
                 <h4 class="tx-gray-800 mg-b-5 form-heading">Cresta Zone</h4>
                 <p class="mg-b-0"></p>
             </div>
         </div>
     </div><br>
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <select class="form-control select2" data-placeholder="Select City" id="zoneCity" name="zoneCity" required <?php echo $disabled?>>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="zoneName" id="zoneName" required value="<?php if(isset($data)){print($data->zoneName);}?>" placeholder="Enter Name" <?php echo $disabled?>>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="zoneLat" id="zoneLat" required value="<?php if(isset($data)){print($data->zoneLat);}?>" placeholder="Enter Latitude" <?php echo $disabled?>>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group form-validate mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="zoneLong" id="zoneLong" required value="<?php if(isset($data)){print($data->zoneLong);}?>" placeholder="Enter Longitude" <?php echo $disabled?>>
                                </div>
                            </div>
                        </div>
